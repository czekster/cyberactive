...
<div class="w3-main" style="margin-left:250px">
 <div class="w3-row w3-padding-64">
  <div class="w3-twothird w3-container" style="width:50%">
    <h1 class="w3-text-teal">Cyber-A<font color="gray"><b>cti</b></font>VE - change password</h1>

    <form class="w3-container" method="POST" action="login_update_user_do.php" name="loginform">
     ...
     <label>Repeat password:</label>
      <input class="w3-input w3-border" type="password" name="passwd2"></p>
